...
I built an end-to-end **CNN Image Classification Model** which identifies the food in your image. 

I worked with a pre-trained Image Classification Model that comes with Keras and then retrained it on the infamous **Food101** Dataset.
...
> If you actually want to know the Nuts and Bolts how the model was trained check out **[`model_training.ipynb`](https://github.com/Donzark/Food_vision/blob/main/model_training.ipynb) Notebook**
...
> Again if you want to dive deeper on how the model was trained check out **[`model_training.ipynb`](https://github.com/Donzark/Food_vision/blob/main/model_training.ipynb) Notebook**
...
Once the model is exported then there comes the Deployment part. Check out  **[`streamlit_app.py`](https://github.com/Donzark/Food_vision/blob/main/streamlit_app.py)** to get more insight on How I integrated it with Streamlit.
...
* `stream_app.py`  : Our Food Vision app built using Streamlit
...
Post your queries on the [**Discussions**](https://github.com/Donzark/food_vision/discussions) tab, else contact me : abdulrazakadekunle@gmail.com
